...
public class ProdutoDAO {
	...
	public ProdutoModel Buscar(String valor) {
		...
		try (Connection conn = Conexao.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
			...
			if (rs.next()) {
				return new ProdutoModel(rs.getInt("id"), rs.getString("nome"), rs.getString("codigo_barras"),
						rs.getString("descricao"), rs.getDouble("preco_custo"), rs.getDouble("preco_venda"),
						rs.getInt("estoque"), rs.getInt("estoque_minimo"), rs.getString("categoria"));
	...
	public static List<ProdutoModel> listarTodos(String valor) {
		...
		try (Connection conn = Conexao.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
			...
			while (rs.next()) {
				ProdutoModel p = new ProdutoModel(rs.getInt("id"), rs.getString("nome"), rs.getString("codigo_barras"),
						rs.getString("descricao"), rs.getDouble("preco_custo"), rs.getDouble("preco_venda"),
						rs.getInt("estoque"), rs.getInt("estoque_minimo"), rs.getString("categoria"));
